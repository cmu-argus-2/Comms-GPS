...
Unlocked GPS module: Orion B16 GNSS Receiver
    - Datasheet: https://navspark.mybigcommerce.com/content/Orion_B16_DS.pdf
    - Application Note: https://navspark.mybigcommerce.com/content/AN0037.pdf
    - Store Page (for reference): https://navspark.mybigcommerce.com/content/AN0037.pdf
    - NMEA Messages: $GPGGA, $GNGLL, $GNGSA, $GPGSV, $GLGSV, $GAGSV, $GBGSV, $GNRMC, $GNVTG, $GNZDA

Locked GPS module: SkyTraq PX1120S L1 GNSS
    - Datasheet: https://navspark.mybigcommerce.com/content/PX1120S_DS.pdf
    - Store Page (for reference): https://navspark.mybigcommerce.com/px1120s-l1-gnss/
    - NMEA Messages: $GPGGA, $GNGLL, $GNGSA, $GPGSV, $GLGSV, $GAGSV, $GBGSV, $GNRMC, $GNVTG, $GNZDA

This is a customized version of Adafruit CircuitPython GPS code, found here: https://github.com/adafruit/Adafruit_CircuitPython_GPS/blob/main/adafruit_gps.py

Adrian Walker
Argus II CubeSat Project
...
_SENTENCE_PARAMS = (
    ...
    # d - A number parseable as degrees
    # D - A number parseable as degrees or Nothing
    # f - A floating point number
    # i - An integer
    # I - An integer or Nothing
    # s - A string
